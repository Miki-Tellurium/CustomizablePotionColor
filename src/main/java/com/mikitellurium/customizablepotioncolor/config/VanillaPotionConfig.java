...
public class VanillaPotionConfig {
    ...
    public static void registerVanillaPotionColorConfig() throws IOException {
        ...
        VanillaEffectsConfigRegistry.CONFIG_SPEED = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "speedEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_SLOWNESS = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "slownessEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_HASTE = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "hasteEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_MINING_FATIGUE = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "miningFatigueEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_STRENGTH = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "strengthEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_INSTANT_HEALTH = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "instantHealthEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_INSTANT_DAMAGE = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "instantDamageEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_JUMP_BOOST = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "jumpBoostEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_NAUSEA = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "nauseaEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_REGENERATION = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "regenerationEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_RESISTANCE = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "resistanceEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_FIRE_RESISTANCE = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "fireResistanceEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_WATER_BREATHING = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "waterBreathingEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_INVISIBILITY = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "invisibilityEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_BLINDNESS = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "blindnessEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_NIGHT_VISION = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "nightVisionEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_HUNGER = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "hungerEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_WEAKNESS = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "weaknessEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_POISON = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "poisonEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_WITHER = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "witherEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_HEALTH_BOOST = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "healthBoostEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_ABSORPTION = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "absorptionEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_SATURATION = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "saturationEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_GLOWING = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "glowingEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_LEVITATION = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "levitationEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_LUCK = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "luckEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_UNLUCK = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "unluckEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_SLOW_FALLING = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "slowFallingEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_CONDUIT_POWER = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "conduitPowerEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_DOLPHIN_GRACE = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "dolphinGraceEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_BAD_OMEN = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "badOmenEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_HERO_OF_THE_VILLAGE = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "heroOfTheVillageEffectColor",
        ...
        VanillaEffectsConfigRegistry.CONFIG_DARKNESS = new EffectColorEntry(VANILLA_POTIONS_CONFIGS, "darknessEffectColor",
