...
public class Colorinator {
    ...
    public static int getEffectColor(MobEffect effect, TelluriumConfig.ConfigEntry<String> setting) {
        return getEffectColor(effect, setting.getValue());
    }

    public static int getEffectColor(MobEffect effect, String value) {
